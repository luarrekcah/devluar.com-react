          ...
          <Container id="sobre">
            ...
            <div style={{ textJustify: "auto" }}>
              <p style={{ textAlign: "left" }}>
                ...
                desenvolvimento de sistemas. Durante sua carreira, tem se
                destacado pelo desenvolvimento e manutenção de sites, além de
                dominar tecnologias específicas para tarefas relacionadas.
              </p>
              <p style={{ textAlign: "left" }}>
